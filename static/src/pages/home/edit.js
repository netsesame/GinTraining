loader.define(function(require,exports,module){
    ...
    pageview.bindExchange = function(val){
        ...
        var ab = function(tmpArray){
            ...
            Exchange_Select.value(val.exchange);
            Exchange_Select.text(val.exchange);
        }
        if(tmpArray){
            ab(tmpArray);            
        }else{
    ...
    pageview.bindOrderType = function(val){
        ...
        var ab = function(tmpArray){
            ...
            orderType_Select.value(val.order_type);
            orderType_Select.text(val.order_type);
        }
        if(tmpArray){
            ab(tmpArray);
        }else{
    ...
    pageview.bindTraders = function(val){
        ...
        var ab = function(tmpArray){
            ...
            traders_Select.value(val.traders.join(","));
            traders_Select.text(val.traders.join(","));
            bs.m.traders = val.traders.join(",");
        }
        if(tmpArray){
            ab(tmpArray);
        }else{
    ...
    pageview.init = function(callback){
        ...
        var exchange = param.exchange;
        bui.ajax({
            url: `${store.Host}getitems/${app_id}/`,
    ...
    pageview.init(function(detail){
        pageview.bindExchange(detail);
        pageview.bindOrderType(detail);
        pageview.bindTraders(detail);
    });
